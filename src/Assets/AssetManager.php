		...
		if ( false !== strpos( $hook, 'pizzalayer-layer-wizard' ) ) {
			...
			wp_localize_script(
				...
				[
					...
					'i18n'       => [
						'detailsFor'           => __( 'Details for your', 'pizzalayer' ),
						'uploadLayerImage'     => __( 'Upload Layer Image', 'pizzalayer' ),
						'chooseLayerImage'     => __( 'Choose Layer Image', 'pizzalayer' ),
						'useThisImage'         => __( 'Use this image', 'pizzalayer' ),
						'noImageSelected'      => __( 'No image selected', 'pizzalayer' ),
						'name'                 => __( 'Name', 'pizzalayer' ),
						'slug'                 => __( 'Slug', 'pizzalayer' ),
						'description'          => __( 'Description', 'pizzalayer' ),
						'priceModifier'        => __( 'Price modifier', 'pizzalayer' ),
						'thickness'            => __( 'Thickness', 'pizzalayer' ),
						'calories'             => __( 'Calories', 'pizzalayer' ),
						'diameter'             => __( 'Diameter', 'pizzalayer' ),
						'spiceLevel'           => __( 'Spice level', 'pizzalayer' ),
						'vegetarian'           => __( 'Vegetarian', 'pizzalayer' ),
						'vegan'                => __( 'Vegan', 'pizzalayer' ),
						'glutenFree'           => __( 'Gluten-Free', 'pizzalayer' ),
						'dairyFree'            => __( 'Dairy-Free', 'pizzalayer' ),
						'dietary'              => __( 'Dietary', 'pizzalayer' ),
						'image'                => __( 'Image', 'pizzalayer' ),
						'imageNoneCanAddLater' => __( 'None (can be added later)', 'pizzalayer' ),
						'errorSavingLayer'     => __( 'Error saving layer:', 'pizzalayer' ),
						'unknownError'         => __( 'Unknown error.', 'pizzalayer' ),
						'networkError'         => __( 'Network error. Please try again.', 'pizzalayer' ),
						'wasSaved'             => __( 'was saved!', 'pizzalayer' ),
						'successDesc'          => __( 'Your new layer has been created. Use the shortcode below to include it on any page.', 'pizzalayer' ),
						'copy'                 => __( 'Copy', 'pizzalayer' ),
						'copied'               => __( 'Copied!', 'pizzalayer' ),
						'editLayer'            => __( 'Edit Layer', 'pizzalayer' ),
						'all'                  => __( 'All', 'pizzalayer' ),
						'buildAnotherLayer'    => __( 'Build Another Layer', 'pizzalayer' ),
					],
				]
			);
		}
