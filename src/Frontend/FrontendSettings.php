...
class FrontendSettings {
	...
	private function build_layer_inset_css(): string {
		...
		$crust_pad   = $px( 'pizzalayer_setting_crust_padding' );
		$sauce_pad   = $px( 'pizzalayer_setting_sauce_padding' );
		$cheese_dist = $px( 'pizzalayer_cheese_setting_cheesedistance' );
		$cheese_pad  = $px( 'pizzalayer_setting_cheese_padding' );
