 ...
 *
 * @param string $color Hex color code (e.g., "#ff6600" or "ff6600").
 * @param float  $alpha Alpha transparency value (0 to 1).
 *
 * @return string RGBA color string or default fallback.
 */
function hex2rgba( $color, $alpha ) {
	$color = trim( ltrim( $color, '#' ) );

	// Expand short hex to full hex (e.g., "f60" → "ff6600")
	if ( strlen( $color ) === 3 ) {
	...
	if ( ! preg_match( '/^[a-f0-9]{6}$/i', $color ) ) {
		return 'rgba(0,0,0,' . floatval( $alpha ) . ')'; // fallback to black
	}
	...
	return sprintf( 'rgba(%d,%d,%d,%.2f)', $r, $g, $b, floatval( $alpha ) );
}
...
$pizzalayer_template_orderboard_option_header_menu_type = get_option('pizzalayer_setting_template_orderboard_header_menu_type');
 return '<div class="pizzalayer-template-orderboard-header-menu pizzalayer-template-orderboard-header-menu-type-' . $pizzalayer_template_orderboard_option_header_menu_type . '">
 ' . pizzalayer_template_orderboard_options_reset_button('top') . '</div>';   
}
...
return '<!-- Pizzalayer : MENU UI -->
<div class="pizzalayer-ui-menu pizzalayer-ui-menu-row pizzalayer-ui-menu-icons pizzalayer-ui-menu-icons-' . $pizzalayer_template_orderboard_element_style_tabs . '">' . pizzalayer_icons_menu_header() . '
<div id="pizzalayer-ui-menu-items" class="col-sm-12">
<ul>
...
if(get_option('pizzalayer_setting_template_orderboard_display_tabs_icons_menu') == 'hide'){ return ''; };
return'<!-- Pizzalayer : MENU UI -->
...
' . pizzalayer_template_orderboard_options_reset_button('foot') . '
...
<a href="#" class="pizzalayer-button"><i class="fa fa-cart-plus"></i> Add to Cart</a>' . pizzalayer_template_orderboard_options_reset_button('cta') . '
...
function pizzalayer_template_orderboard_options_reset_button($ResetButtonLocation){
//get field for reset location from user options     
$ResetButtonLocationPreference = get_option('pizzalayer_setting_template_orderboard_button_reset_location');
