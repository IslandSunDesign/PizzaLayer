<?php
/**
 * PizzaLayerPro — Checkout Bar: Colorbox
 *
 * Included by PizzaLayerPro's CartIntegration when a pizza product page is
...
<div class="pztpro-checkout-bar pztpro-checkout-bar--colorbox"
	...
	<div class="pztpro-bar-row">
		...
		<button type="button"
			...
			<span class="pztpro-bar-row__btn-text"><?php esc_html_e( 'Add to Cart', 'pizzalayerpro' ); ?></span>
		</button>
	</div>
