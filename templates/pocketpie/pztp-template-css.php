 ...
 */
function pizzalayer_template_pocketpie_generated_css() {
    ...
    /* ── Custom CSS ────────────────────────────────────────────────── */
    $custom = trim( $g( 'pocketpie_setting_custom_css', '' ) );
    if ( $custom !== '' ) {
        // '<' is never valid in CSS — stripping it prevents any tag injection
        // while leaving combinators (>) and the rest of the syntax intact.
        $css .= str_replace( '<', '', $custom );
    }
